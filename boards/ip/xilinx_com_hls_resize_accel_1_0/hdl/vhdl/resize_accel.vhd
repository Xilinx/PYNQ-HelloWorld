...
architecture behav of resize_accel is 
    ...
    "resize_accel,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=9.400000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=10,HLS_SYN_DSP=15,HLS_SYN_FF=4570,HLS_SYN_LUT=5522}";
    ...
    signal Block_Mat_exit41_pro_U0_ap_start : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_start_full_n : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_done : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_continue : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_idle : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_start_out : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_start_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_dst_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_dst_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_dst_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_dst_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_p_src_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_p_src_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_p_src_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_p_src_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_p_dst_rows_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_p_dst_rows_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_p_dst_cols_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_Mat_exit41_pro_U0_p_dst_cols_out_write : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_return_0 : STD_LOGIC_VECTOR (8 downto 0);
    signal Block_Mat_exit41_pro_U0_ap_return_1 : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal p_src_rows_c_full_n : STD_LOGIC;
    signal p_src_rows_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_src_rows_c_empty_n : STD_LOGIC;
    signal p_src_cols_c_full_n : STD_LOGIC;
    signal p_src_cols_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_src_cols_c_empty_n : STD_LOGIC;
    signal p_dst_rows_c_full_n : STD_LOGIC;
    signal p_dst_rows_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_rows_c_empty_n : STD_LOGIC;
    signal p_dst_cols_c_full_n : STD_LOGIC;
    signal p_dst_cols_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_cols_c_empty_n : STD_LOGIC;
    signal src_rows_cast_loc_ch_dout : STD_LOGIC_VECTOR (8 downto 0);
    signal src_rows_cast_loc_ch_empty_n : STD_LOGIC;
    signal src_cols_cast_loc_ch_dout : STD_LOGIC_VECTOR (9 downto 0);
    signal src_cols_cast_loc_ch_empty_n : STD_LOGIC;
    signal p_src_data_V_channel_full_n : STD_LOGIC;
    signal p_src_data_V_channel_dout : STD_LOGIC_VECTOR (23 downto 0);
    signal p_src_data_V_channel_empty_n : STD_LOGIC;
    signal p_dst_data_V_channel_full_n : STD_LOGIC;
    signal p_dst_data_V_channel_dout : STD_LOGIC_VECTOR (23 downto 0);
    signal p_dst_data_V_channel_empty_n : STD_LOGIC;
    ...
    signal ap_sync_reg_Block_Mat_exit41_pro_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_Mat_exit41_pro_U0_ap_ready : STD_LOGIC;
    signal Block_Mat_exit41_pro_U0_ap_ready_count : STD_LOGIC_VECTOR (1 downto 0) := "00";
    ...
    component Block_Mat_exit41_pro IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ...
        p_src_rows_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        p_src_rows_out_full_n : IN STD_LOGIC;
        p_src_rows_out_write : OUT STD_LOGIC;
        p_src_cols_out_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        p_src_cols_out_full_n : IN STD_LOGIC;
        p_src_cols_out_write : OUT STD_LOGIC;
...
begin
    ...
    Block_Mat_exit41_pro_U0 : component Block_Mat_exit41_pro
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    dst_rows_c_U : component fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    dst_cols_c_U : component fifo_w32_d3_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_src_rows_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_src_cols_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_rows_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_cols_c_U : component fifo_w32_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_rows_cast_loc_ch_U : component fifo_w9_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    src_cols_cast_loc_ch_U : component fifo_w10_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_src_data_V_channel_U : component fifo_w24_d150_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    p_dst_data_V_channel_U : component fifo_w24_d150_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    ap_sync_reg_Block_Mat_exit41_pro_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_Mat_exit41_pro_U0_ap_ready <= ap_const_logic_0;
            else
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((Block_Mat_exit41_pro_U0_ap_done and Block_Mat_exit41_pro_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_src_cols_cast_loc_ch <= ap_const_logic_0;
                else 
    ...
    Block_Mat_exit41_pro_U0_ap_ready_count_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = Block_Mat_exit41_pro_U0_ap_ready) and (ap_sync_ready = ap_const_logic_1))) then 
                Block_Mat_exit41_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit41_pro_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_sync_ready = ap_const_logic_0) and (ap_const_logic_1 = Block_Mat_exit41_pro_U0_ap_ready))) then 
                Block_Mat_exit41_pro_U0_ap_ready_count <= std_logic_vector(unsigned(Block_Mat_exit41_pro_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    Block_Mat_exit41_pro_U0_ap_continue <= (ap_sync_channel_write_src_rows_cast_loc_ch and ap_sync_channel_write_src_cols_cast_loc_ch);
    Block_Mat_exit41_pro_U0_ap_start <= ((ap_sync_reg_Block_Mat_exit41_pro_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Block_Mat_exit41_pro_U0_start_full_n <= (start_for_xfMat2axis_U0_full_n and start_for_resize_U0_full_n);
    ap_channel_done_src_cols_cast_loc_ch <= ((ap_sync_reg_channel_write_src_cols_cast_loc_ch xor ap_const_logic_1) and Block_Mat_exit41_pro_U0_ap_done);
    ap_channel_done_src_rows_cast_loc_ch <= ((ap_sync_reg_channel_write_src_rows_cast_loc_ch xor ap_const_logic_1) and Block_Mat_exit41_pro_U0_ap_done);
    ap_done <= xfMat2axis_U0_ap_done;
    ap_idle <= (xfMat2axis_U0_ap_idle and resize_U0_ap_idle and (src_cols_cast_loc_ch_empty_n xor ap_const_logic_1) and (src_rows_cast_loc_ch_empty_n xor ap_const_logic_1) and axis2xfMat_U0_ap_idle and Block_Mat_exit41_pro_U0_ap_idle);
    ...
    ap_sync_Block_Mat_exit41_pro_U0_ap_ready <= (ap_sync_reg_Block_Mat_exit41_pro_U0_ap_ready or Block_Mat_exit41_pro_U0_ap_ready);
    ...
    ap_sync_ready <= (ap_sync_axis2xfMat_U0_ap_ready and ap_sync_Block_Mat_exit41_pro_U0_ap_ready);
