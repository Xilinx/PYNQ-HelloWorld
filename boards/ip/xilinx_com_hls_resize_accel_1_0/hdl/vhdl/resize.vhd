...
architecture behav of resize is 
    ...
    signal p_src_rows_read_reg_68 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal p_src_cols_read_reg_73 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_rows_read_reg_78 : STD_LOGIC_VECTOR (31 downto 0);
    signal p_dst_cols_read_reg_83 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_resizeNNBilinear_fu_52_ap_start : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_ap_done : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_ap_idle : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_ap_ready : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_imgInput_data_V_read : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_imgOutput_data_V_din : STD_LOGIC_VECTOR (23 downto 0);
    signal grp_resizeNNBilinear_fu_52_imgOutput_data_V_write : STD_LOGIC;
    signal grp_resizeNNBilinear_fu_52_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_resizeNNBilinear_fu_52 : component resizeNNBilinear
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_resizeNNBilinear_fu_52_ap_start,
        ap_done => grp_resizeNNBilinear_fu_52_ap_done,
        ap_idle => grp_resizeNNBilinear_fu_52_ap_idle,
        ap_ready => grp_resizeNNBilinear_fu_52_ap_ready,
        imgInput_rows_read => p_src_rows_read_reg_68,
        imgInput_cols_read => p_src_cols_read_reg_73,
        imgInput_data_V_dout => p_src_data_V_dout,
        imgInput_data_V_empty_n => p_src_data_V_empty_n,
        imgInput_data_V_read => grp_resizeNNBilinear_fu_52_imgInput_data_V_read,
        imgOutput_rows_read => p_dst_rows_read_reg_78,
        imgOutput_cols_read => p_dst_cols_read_reg_83,
        imgOutput_data_V_din => grp_resizeNNBilinear_fu_52_imgOutput_data_V_din,
        imgOutput_data_V_full_n => p_dst_data_V_full_n,
        imgOutput_data_V_write => grp_resizeNNBilinear_fu_52_imgOutput_data_V_write);
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_resizeNNBilinear_fu_52_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_resizeNNBilinear_fu_52_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_resizeNNBilinear_fu_52_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (p_dst_cols_empty_n = ap_const_logic_0) or (p_dst_rows_empty_n = ap_const_logic_0) or (p_src_cols_empty_n = ap_const_logic_0) or (p_src_rows_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_resizeNNBilinear_fu_52_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_resizeNNBilinear_fu_52_ap_ready = ap_const_logic_1)) then 
                    grp_resizeNNBilinear_fu_52_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (p_dst_cols_empty_n = ap_const_logic_0) or (p_dst_rows_empty_n = ap_const_logic_0) or (p_src_cols_empty_n = ap_const_logic_0) or (p_src_rows_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                p_dst_cols_read_reg_83 <= p_dst_cols_dout;
                p_dst_rows_read_reg_78 <= p_dst_rows_dout;
                p_src_cols_read_reg_73 <= p_src_cols_dout;
                p_src_rows_read_reg_68 <= p_src_rows_dout;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_rows_empty_n, p_src_cols_empty_n, p_dst_rows_empty_n, p_dst_cols_empty_n, grp_resizeNNBilinear_fu_52_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_resizeNNBilinear_fu_52_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_block_state1_ignore_call10_assign_proc : process(ap_start, ap_done_reg, p_src_rows_empty_n, p_src_cols_empty_n, p_dst_rows_empty_n, p_dst_cols_empty_n)
    begin
                ap_block_state1_ignore_call10 <= ((ap_start = ap_const_logic_0) or (p_dst_cols_empty_n = ap_const_logic_0) or (p_dst_rows_empty_n = ap_const_logic_0) or (p_src_cols_empty_n = ap_const_logic_0) or (p_src_rows_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1));
    end process;


    ap_done_assign_proc : process(ap_done_reg, grp_resizeNNBilinear_fu_52_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_resizeNNBilinear_fu_52_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(grp_resizeNNBilinear_fu_52_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_resizeNNBilinear_fu_52_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_resizeNNBilinear_fu_52_ap_start <= grp_resizeNNBilinear_fu_52_ap_start_reg;
    ...
    p_dst_data_V_din <= grp_resizeNNBilinear_fu_52_imgOutput_data_V_din;

    p_dst_data_V_write_assign_proc : process(grp_resizeNNBilinear_fu_52_imgOutput_data_V_write, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_dst_data_V_write <= grp_resizeNNBilinear_fu_52_imgOutput_data_V_write;
        else 
    ...
    p_src_data_V_read_assign_proc : process(grp_resizeNNBilinear_fu_52_imgInput_data_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_data_V_read <= grp_resizeNNBilinear_fu_52_imgInput_data_V_read;
        else 
